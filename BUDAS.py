...
import numpy as np
import time
from GeoUtil import calArea, calArea2, checkadjacent
...
options: 
  ...
  -s <directory>       : directory to store the result files
...
if (not batch_process):
  [room_img_res2, textlist, sizelist, doorlist, openinglist]  = Annotator.annotator(image, room_img_res)
  print(textlist)
  print(doorlist)
  print(openinglist)
